...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1>Assign Group: <small>Control Panel</small></h1>
        <ol class="breadcrumb">
          <li><a href="index.php"><i class="icon-dashboard"></i> Dashboard</a></li>
          <li class="active"><i class="icon-file-alt"></i> Assign Group</li>
        </ol>
        <hr />
      </div><!-- /.col-lg-12 -->
    </div><!-- /.row -->
      ...
      <div class="clearfix"></div>
        <div class="panel tbp-panel-inverse">
          <div class="panel-heading">
            <h3 class="panel-title"><strong>Assign Group</strong></h3>
          </div>
          <div class="panel-body">
             <form class="form" role="form">
              <div class="row">
                <div class="col-lg-6">
                  <label class="control-label">Select a Quiz that you Would Like to Assign this Group to</label>
                  <div>
              ...
              <div class="form-group pull-right">
                ...
                <button type="submit" class="btn btn-primary">Assign Group Now</button>
              </div>
            </div>
            </form>
          </div>
